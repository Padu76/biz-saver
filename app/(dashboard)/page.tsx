...
const CATEGORIES = [
  {
    ...
    desc: "Bolletta luce, gas, forniture energetiche per uffici e attività.",
  },
  {
  ...
  },
  {
    ...
    desc: "Connessioni fibra, FTTC, FWA per uffici e studi.",
  },
  {
    label: "Assicurazioni",
    desc: "Polizze RC, assicurazioni auto, uffici, professionisti.",
  },
  {
    label: "Noleggio auto lungo termine",
    desc: "Contratti di noleggio per auto aziendali e veicoli di servizio.",
  },
];
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
        <div>
          <h1 className="text-2xl font-semibold">Biz Saver – Dashboard</h1>
          <p className="mt-1 max-w-2xl text-sm text-slate-300">
            Carica bollette e contratti, lascia che l&apos;AI li legga e scopri
            quanto puoi risparmiare passando alle offerte più efficienti.
          </p>
        </div>
